...
public class DataAccess {
    ...
    public DataAccess (String query ,boolean t) {
        try {
            if ( t == false ) {
    ...
    public ArrayList<ArrayList<Object>> getAllRecordsFromProcedure (String query) {
        ...
        try {
            ...
            Logger.getLogger (DataAccess.class.getName ()).
            log (Level.SEVERE ,
            null ,
            ex);
        }
